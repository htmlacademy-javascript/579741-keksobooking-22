...
const MIN_X_COORDINATE = 35.65;
const MAX_X_COORDINATE = 35.7;
const MIN_Y_COORDINATE = 139.7;
const MAX_Y_COORDINATE = 139.8;
...
const createSimilarAd = () => {
  ...
  const xCoord = getRandomFloatNumber(
    MIN_X_COORDINATE,
    MAX_X_COORDINATE,
    DIGITS_COORDINATE,
  );
  const yCoord = getRandomFloatNumber(
    MIN_Y_COORDINATE,
    MAX_Y_COORDINATE,
    DIGITS_COORDINATE,
  );
